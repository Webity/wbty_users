		...
		<thead>
			<tr>
                ...
                <th></th>
					...
					<th>
						<?php echo JHtml::_('grid.sort',  'COM_WBTY_USERS_FORM_LBL_FIELDS_FIELD_TYPE', 'field_types.field_types_display', $listDirn, $listOrder); ?>
					</th>
                	...
                	<div class="btn-group">
                      ...
                      <ul class="dropdown-menu">
						...
						<td>
							...
							<?php endif; ?>
							<?php echo $this->escape($item->field_types_display); ?>
						</td>
						
						<td>
							<?php echo ($item->list_view ? 'Yes' : 'No'); ?>
						</td>
