...
class Wbty_usersViewComponent_Assets extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_WBTY_USERS_TITLE_COMPONENT_ASSETS'), 'component_assets.png');
        ...
        if (file_exists($formPath)) {
            ...
            if ($canDo->get('core.create')) {
			    JToolBarHelper::addNew('component_asset.add','JTOOLBAR_NEW');
		    }

		    if ($canDo->get('core.edit') && isset($this->items[0])) {
			    JToolBarHelper::editList('component_asset.edit','JTOOLBAR_EDIT');
		    }
		...
		if ($canDo->get('core.edit.state') && isset($this->items[0]->state)) {
            ...
            if ($this->state->get('filter.state') == -2) { 
			    ...
			    JToolBarHelper::custom('component_assets.publish', 'publish.png', 'publish_f2.png','JTOOLBAR_PUBLISH', true);
            } else {
			    JToolBarHelper::divider();
			    JToolBarHelper::trash('component_assets.trash','JTOOLBAR_TRASH');
		    }
        }
	}
}
