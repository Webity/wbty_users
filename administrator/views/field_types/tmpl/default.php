...
<form action="<?php echo JRoute::_('index.php?option=com_wbty_users&view=field_types'); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
		...
		<thead>
			<tr>
                ...
                <th></th>
					...
					<th>
						<?php echo JHtml::_('grid.sort',  'COM_WBTY_USERS_FORM_LBL_FIELD_TYPES_DISPLAY', '.display', $listDirn, $listOrder); ?>
					</th>
					
					<th>
						<?php echo JHtml::_('grid.sort',  'COM_WBTY_USERS_FORM_LBL_FIELD_TYPES_VALUE', '.value', $listDirn, $listOrder); ?>
					</th>
                ...
                <td class="center">
                	<div class="btn-group">
                      ...
                      <ul class="dropdown-menu">
                        <?php
                        echo '<li><a href="index.php?option=com_wbty_users&view=field_type&layout=default&id='.$item->id.'">View</a></li>';
						if ($canEdit && $this->state->get('filter.state') != -2) {
	                        echo '<li><a href="index.php?option=com_wbty_users&task=field_type.edit&id='.$item->id.'">Edit</a></li>';
						}
                        ?>
