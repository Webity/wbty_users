...
class Wbty_usersModelfields extends WbtyModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->select('field_types1386.display as field_types_display');
		$query->join('LEFT', '#__wbty_users_field_types as field_types1386 ON a.field_type=field_types1386.value');
