...
jQuery(document).ready(function($) {
	...
	if ($('.component-content').length > 0) {
		$('body').on('click', '.component-content .btn', function(e) {
			e.preventDefault();
		});
	} else {
	...
	$('.save-primary').click(function() {
		...
		$(this).after('<img src="'+window.juri_root+'/media/wbty_users/img/load.gif" class="loading" />');
		task = $(this).closest('fieldset').attr('data-task');
		url = 'index.php?option=com_wbty_users&task='+task;
	...
	$(document).on('click', '.inline-edit-trigger', function(e) {
		...
		url = window.juri_base + 'index.php?option=com_wbty_users&task='+ $this.attr('data-controller') + '.edit';
	...
	$('body').on('click', '.inline-edit-save-btn', function(e) {
		...
		url = window.juri_base + 'index.php?option=com_wbty_users&task='+ $fields.attr('data-controller') + '.ajax_save';
		
		if ($fields.attr('data-append')) {
			url = url + '&' + $fields.attr('data-append');
		}
		
		$(this).closest('.edit-form').after($('<p style="text-align:center;" data-update="'+$(this).closest('.edit-form').attr('data-update')+'" data-fieldset="'+$(this).closest('.edit-form').attr('data-fieldset')+'"><img src="'+window.juri_root+'media/wbty_users/img/load.gif" /></p>'));
