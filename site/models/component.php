 ...
 * Wbty_users model.
 */
class Wbty_usersModelcomponent extends WbtyModelAdmin
{
	protected $text_prefix = 'com_wbty_users';
	protected $com_name = 'wbty_users';
	protected $list_name = 'components';
	
	public function getTable($type = 'components', $prefix = 'Wbty_usersTable', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true, $control='jform', $key=0)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_wbty_users.component.'.$control.'.'.$key, 'component', array('control' => $control, 'load_data' => $loadData, 'key'=>$key));
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_wbty_users.edit.component.data', array());
	...
	{
		if ($item['component'] = parent::getItem($pk)) {
