...
<form action="<?php echo JRoute::_('index.php?option=com_wbty_users&view=fields'); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
	...
	<h2 class="title centered"><?php echo JText::_('fields'); ?></h2>
	<div class="clr"></div>
		...
		<thead>
			<tr>
				...
				<th></th>
					...
					<th>
						<?php echo JHtml::_('grid.sort',  'COM_WBTY_USERS_FORM_LBL_FIELDS_FIELD_TYPE', 'field_types.field_types_', $listDirn, $listOrder); ?>
					</th>
					
					<th>
						<?php echo JHtml::_('grid.sort',  'COM_WBTY_USERS_FORM_LBL_FIELDS_LIST_VIEW', 'field_types.list_view', $listDirn, $listOrder); ?>
					</th>
                ...
                <td class="center">
                	<div class="btn-group">
                      ...
                      <ul class="dropdown-menu">
                        <?php
                        echo '<li><a href="index.php?option=com_wbty_users&view=field&layout=default&id='.$item->id.'">View</a></li>';
						if ($canEdit && $this->state->get('filter.state') != -2) {
	                        echo '<li><a href="index.php?option=com_wbty_users&task=field.edit&id='.$item->id.'">Edit</a></li>';
						}
                        ?>
						...
						<td>
							...
							<?php endif; ?>
							<?php echo $this->escape($item->field_types_); ?>
						</td>
						
						<td>
							<?php echo $item->list_view; ?>
						</td>
