...
<form action="<?php echo JRoute::_('index.php?option=com_wbty_users&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="field-form" class="formview form-validate form-horizontal">
