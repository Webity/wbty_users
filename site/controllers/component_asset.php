...
/**
 * component_asset controller class.
 */
class Wbty_usersControllerComponent_Asset extends WbtyControllerForm
{

    function __construct() {
        $this->view_list = 'component_assets';
        parent::__construct();
	...
	function ajax_save() {
		...
		if (JSession::checkToken() && $id = $this->model->save($data, array())) {
			...
			$return['id'] = $id;
			$return['data'] = $helper->link_html('component_asset', $id, $form);
	...
	protected function getRedirectToItemAppend($recordId = null, $urlVar = 'id')
	{
		...
		$append .= '&component_id=' . JRequest::getVar('component_id');
